        ...
        <div className="auth-card panel">
          ...
          <div className="panel-content auth-content">
            ...
            {!isSignupOtpStep ? (
              ...
              <>
                <p className="auth-helper">Enter the OTP sent to {authForm.email}</p>
                <div className="form-group">
                  ...
                  <input
                    ...
                    type="text"
                    value={authForm.otp}
                    onChange={(e) => setAuthForm((prev) => ({ ...prev, otp: e.target.value.replace(/\D/g, '').slice(0, 8) }))}
            ...
            <button
              ...
              title={
                authMode === 'signup'
                  ? (isSignupOtpStep ? 'Verify OTP' : 'Send OTP')
                  : 'Login'
              }
            >
              {isAuthLoading
                ? 'Please wait...'
                : authMode === 'signup'
                  ? (isSignupOtpStep ? 'Verify & Create Account' : 'Send OTP')
                  : 'Login'}
            </button>
